...
// Ключ уникальности — PRIMARY KEY (url, period_label). 
// То есть если перезапустишь скрипт для тех же 40 URL и тех же периодов (2025-H1/2026-H1) — старые строки просто обновятся актуальными цифрами. 
// Если добавишь новый URL в список или новый период в PERIODS — появятся новые строки, старые не тронутся.
